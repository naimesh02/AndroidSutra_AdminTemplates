                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Category Details Tables</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div  style="background-color:#0B5790; border:thick; border-radius:50px; height:30px; width:200px; text-align:center; font-size:17px; color:#FFFFFF;right:0;position:absolute; margin-right :40px;">
                                        ...
                                        <a href="UpdateCategoryDetails.php" style="color:#FFFFFF; font-size:20px;">Add Record</a>
                                        </div>
                                <div class="main-sparkline13-hd">
                                    <h1>Category <span class="table-project-n">Details</span> Table</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                               $sql="SELECT * FROM `tblcategorydetails`";
                               $qry=mysqli_query($conn,$sql);
                               while($res=mysqli_fetch_array($qry)){
                               echo "<tr><td></td><td>".$res["title"]."</td><td>";

                                $catName="select title from tblcategorydata where id='".$res['catData_id']."'";
                               ...
                               echo "</td><td>".$res['storeDate']."</td><td><a href=UpdateCategoryDetails.php?id=".$res["id"]."><img src='Images/pencil.png'></a>&nbsp;&nbsp;&nbsp;<a href=deletecategorydetails.php?id=".$res["id"]." onclick=\"return confirm('Are you sure to delete record?')\"><img src='Images/delete.png'></a></td></tr>";
                               }
                               ?>
