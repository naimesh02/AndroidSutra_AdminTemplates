                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div  style="background-color:#AB1308; border:thick; border-radius:50px; height:30px; width:200px; text-align:center; font-size:17px; color:#FFFFFF;right:0;position:absolute; margin-right :40px;">
										...
										<a href="UpdateData.php?type=<?php echo $_GET["type"]; ?>"  style="color:#FFFFFF;">Add Record</a>
										</div>
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1><?php echo  $_GET['type'];?> <span class="table-project-n">Data</span> Table</h1><span>
                                </div>
                            ...
                            <div class="sparkline13-graph">
							   ...
							   echo "</td><td>".$res['storeDate']."</td><td><a href=UpdateData.php?type=".$_GET['type']."&id=".$res["id"]."><img src='Images/pencil.png'></a>&nbsp;&nbsp;&nbsp;<a href=deleteData.php?type=".$_GET["type"]."&id=".$res["id"]." onclick=\"return confirm('Are you sure to delete record?')\"><img src='Images/delete.png'></a></td></tr>";
							   }
							   ?>
