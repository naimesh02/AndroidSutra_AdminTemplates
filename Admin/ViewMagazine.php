                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Magazines Tables</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div  style="background-color:#0B5790; border:thick; border-radius:50px; height:30px; width:200px; text-align:center; font-size:17px; color:#FFFFFF;right:0;position:absolute; margin-right :40px;">
										...
										<a href="UpdateMagazine.php"  style="color:#FFFFFF; font-size:20px;">Add Record</a>
										</div>
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Magazines <span class="table-project-n">Data</span> Table</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
							   ...
							   echo "<tr><td></td><td>".$res["magazineName"]."</td><td>".$res["description"]."</td>";?>
							   <td><img src="upload/<?php echo $res['image'];?>" style="width:350px;height:100px"/></td>
