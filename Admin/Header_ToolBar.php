    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="dashboard.php"><img class="main-logo" src="img/logo/androidSutra.png" style="width:200px; margin:10px" alt="" /></a>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="" aria-expanded="false"><i class="fa big-icon fa-envelope icon-wrap"></i> <span class="mini-click-non"> Visitors Data</span></a>
                        ...
                        <li>
                            <a class="has-arrow" href="" aria-expanded="false"><i class="fa big-icon fa-flask icon-wrap"></i> <span class="mini-click-non">Main Menu</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                        ...
                        <li>
                            <a class="has-arrow" href="" aria-expanded="false"><i class="fa big-icon fa-pie-chart icon-wrap"></i> <span class="mini-click-non">View Data</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="File Manager" href="ViewRegistration.php"><i class="fa fa-folder sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">User Registrations</span></a></li>
                                <li><a title="Blog" href="Subscription.php"><i class="fa fa-square sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Subscribers</span></a></li>
                                <li><a title="Blog Details" href="Comments.php"><i class="fa fa-tags sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">User Comments</span></a></li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															...
															<span class="admin-name"><?php $uname=$_SESSION["username"]; $uname=substr($uname,0,strpos($uname,'@')); echo $uname; ?></span>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="dashboard.php">Dashboard <!--<span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span>--></a>
